...
def get_adjacent_matrix(distance_file: str, num_nodes: int, id_file: str = None, graph_type="connect",data_type=None) -> np.array:
    ...
    if data_type=='PEMS03':
        ids = Path(os.path.join('../dataset/PEMS/PEMS03/','PEMS03.txt')).read_text().splitlines()
...
def get_loader(ds_name="PEMS04"):
    ...
    train_data = PEMSDataset(data_path=["../dataset/PEMS/{}/{}.csv".format(ds_name,ds_name), "../dataset/PEMS/{}/{}.npz".format(ds_name,ds_name)], num_nodes=num_nodes,
                             divide_days=[45, 14],
    ...
    test_data = PEMSDataset(data_path=["../dataset/PEMS/{}/{}.csv".format(ds_name,ds_name), "../dataset/PEMS/{}/{}.npz".format(ds_name,ds_name)], num_nodes=num_nodes,
                            divide_days=[45, 14],
                            time_interval=5, history_length=6,
