...
import sys
sys.path.append('../')
from backbone.model import GCN, ChebNet, GAT
from utils.metrics import MAE, MAPE, RMSE
from data.data_loader import get_loader
from data.metrla_data_loader import metrla_get_loader
from data.pemsbay_data_loader import pemsbay_get_loader
...
# train_loader, test_loader =metrla_get_loader('metr-la')
# train_loader, test_loader =pemsbay_get_loader('pems-bay')
